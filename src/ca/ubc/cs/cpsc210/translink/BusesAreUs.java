...
public class BusesAreUs extends Activity implements LocationListener, StopSelectionListener {
    ...
    public void onLocationChanged(Stop nearest, LatLon locn) {
     ...
     //   nearest=StopManager.getInstance().findNearestTo(locn);
        if(nearest!=null)
    ...
    public void onStopSelected(Stop stop) {
        ...
        System.out.println("onStopSelected"+stop.getName());
            try {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            new DownloadBusLocationDataTask().execute(StopManager.getInstance().getSelected());
        } else {
